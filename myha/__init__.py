...
app.config['SQLALCHEMY_DATABASE_URI'] = prefix + os.path.join(
    os.path.dirname(app.root_path), os.getenv(
        'DATABASE_FILE', 'my_ha_data.db'))  # 这个在线下一用就找不到数据库的位置，添加了 'program-2022-02-02/' 后可以在线下了。但是！线上一定不能要它！！！
...
import commands, errors, views  # 这条代码改一下！改成下面：

print("跑通！\n","os.path.dirname(app.root_path)：" , os.path.dirname(app.root_path))
